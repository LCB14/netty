...
public abstract class AbstractByteBufAllocator implements ByteBufAllocator {
    ...
    public int calculateNewCapacity(int minNewCapacity, int maxCapacity) {
        ...
        if (minNewCapacity > threshold) {
            ...
            // 经过下面计算后，newCapacity的值一定小于等于threshold（CALCULATE_THRESHOLD）的最小倍数
        ...
        // 如果 minNewCapacity 小于 CALCULATE_THRESHOLD，那么 newCapacity 就会从 64 开始，
        // 一直循环 double , 也就是按照 64 的倍数进行扩容。直到 newCapacity 大于等于 minNewCapacity。
